...
STAT_DESCRIPTIONS = {
    ...
    "Defense": "How much physical damage you are resistant to and ability to block.",
    "Evasion": "How good you are at avoiding/redirecting attacks or escaping bad situations.",
    "Dexterity": "How good you are at using items, like weapons or tools, and the accuracy of use.",
    ...
    "Health": "Your level of general well-being. An unhealthy lifestyle is a worse level of health.",
...
response = model.generate_content(
    ("Generate yes/no questions relating to each of these characteristics and their descriptions: "
     ...
     "\nThe questions should only be answered with yes or no, 1-2 sentences long, "
